...
void pwm_init(void){
  ...
  palSetPadMode(GPIOB, GPIOB_PIN0, PAL_MODE_STM32_ALTERNATE_PUSHPULL);//B0  TIM3 CH3
  palSetPadMode(GPIOA, GPIOA_PIN7, PAL_MODE_STM32_ALTERNATE_PUSHPULL);//C0  TIM3 CH2

  palSetPadMode(GPIOA, GPIOA_PIN6, PAL_MODE_STM32_ALTERNATE_PUSHPULL);//A1  TIM3 CH1
  palSetPadMode(GPIOA, GPIOA_PIN3, PAL_MODE_STM32_ALTERNATE_PUSHPULL);//B1  TIM2 CH4
  palSetPadMode(GPIOA, GPIOA_PIN2, PAL_MODE_STM32_ALTERNATE_PUSHPULL);//C1  TIM2 CH3

  palSetPadMode(GPIOB, GPIOB_PIN9, PAL_MODE_STM32_ALTERNATE_PUSHPULL);//A2  TIM4 CH4
  palSetPadMode(GPIOA, GPIOA_PIN1, PAL_MODE_STM32_ALTERNATE_PUSHPULL);//B2  TIM2 CH2
  palSetPadMode(GPIOB, GPIOB_PIN8, PAL_MODE_STM32_ALTERNATE_PUSHPULL);//C3  TIM4 CH3
